...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Mohon Masukkan Nama Anda.\n';
    }

    if(empty($_POST['visitor_phone']))
    {
        $valid = 0;
        $error_message .= 'Mohon Masukkan No Handphone Anda.\n';
    }
    ...
    else
    {
        ...
        {
            $valid = 0;
            $error_message .= 'Mohon Masukkan Alamat Email Yang Benar.\n';
        }
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Mohon Masukkan Komentar Anda.\n';
    }
					...
					<form accept="<?php echo BASE_URL.URL_PAGE.$_REQUEST['slug']; ?>" method="post">
						<div class="form-row">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="visitor_name" placeholder="Nama Lengkap">
							</div>
...
<div class="blog-page-area">
	<div class="container">
		<div class="row">
			...
			<?php if(!$total): ?>
			<p style="color:red;">Maaf! Tidak Ada Berita Saat Ini.</p>
			<?php else: ?>
				...
				<div class="col-md-4 col-sm-6">
					<div class="packages-item">
						<div class="pack-head">
							...
							<h2>Rp. <?php echo $row['pricing_plan_price']; ?></h2>
							<h4 class="first">Lama Sewa: <?php echo $row['pricing_plan_day']; ?> Hari</h4>
							<h4>Jumlah Upload Produk: <?php echo $row['pricing_plan_item_allow']; ?></h4>
						</div>
						<div class="pack-body">
							<?php echo $row['pricing_plan_description']; ?>
						</div>
						<div class="pack-footer">
							<a href="<?php echo BASE_URL; ?>login.php">Sewa Lapak</a>
						</div>
					</div>
				</div>
				<?php
