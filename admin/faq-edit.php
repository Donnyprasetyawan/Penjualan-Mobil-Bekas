...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['faq_title'])) {
        $valid = 0;
        $error_message .= "Judul FAQ Tidak Boleh Kosong.<br>";
    }

    if(empty($_POST['faq_content'])) {
        $valid = 0;
        $error_message .= "Artikel FAQ Tidak Boleh Kosong.<br>";
    }
    
    if(empty($_POST['faq_category_id'])) {
        $valid = 0;
        $error_message .= "Kamu Harus Memilih Kategori FAQ<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'FAQ Berhasil Di Update..';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="faq.php" class="btn btn-primary btn-sm">Lihat Semua</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Judul FAQ <span>*</span></label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="faq_title" value="<?php echo $faq_title; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Artikel FAQ <span>*</span></label>
							<div class="col-sm-9">
								<textarea class="form-control" name="faq_content" id="editor1"><?php echo $faq_content; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Pilih Kategori FAQ <span>*</span></label>
							<div class="col-sm-4">
