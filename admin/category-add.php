...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['category_name'])) {
        $valid = 0;
        $error_message .= "Nama Kategori Tidak Boleh Kosong.<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Nama Kategori Tersebut Sudah Ada.<br>";
    	}
    }
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="category.php" class="btn btn-primary btn-sm">Lihat Semua</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="category_name" placeholder="Contoh: Mobil Terbaik">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Slug Kategori </label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="category_slug" placeholder="Contoh: mobil-terbaik">
							</div>
						</div>
