	...
	<script>
	  $(function () {
		...
		$('#confirm-verif').on('show.bs.modal', function(e) {
			$("#image-bukti").attr("src", $(e.relatedTarget).data('bukti'));
	      $(this).find('#btn-verif').attr('href', $(e.relatedTarget).data('href'));
	    });
	...
	function confirmPembayaran(type){
		if(type == 'accept'){
			return confirm("Apakah anda yakin ingin memverifikasi pembayaran ini?");
		} else if (type == 'reject') {
			return confirm("Apakah anda yakin ingin menolak pembayaran ini?");
		}
	}
	...
	<script type="text/javascript">
        ...
        $(document).ready(function () {
			$(".btnVerifPenjual").click(function () {
				var seller_id = $(this).data("id");
				var seller_ktp = $(this).data("ktp");

				$("#seller_id").val(seller_id);
				$("#image-ktp").attr("src", seller_ktp);
			});

			$(".btnVerifPembeli").click(function () {
				var pembeli_id = $(this).data("id");
				var pembeli_ktp = $(this).data("ktp");

				$("#pembeli_id").val(pembeli_id);
				$("#image-ktp").attr("src", pembeli_ktp);
			});
