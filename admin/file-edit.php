...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['file_title'])) {
        $valid = 0;
        $error_message .= "Judul File Tidak Boleh Kosong.<br>";
    }
    ...
    if($path != '') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' && $ext!='pdf' && $ext!='doc' && $ext!='docx' && $ext!='ppt' && $ext!='pptx' && $ext!='xls' && $ext!='xlsx' && $ext!='zip' && $ext!='rar' ) {
            $valid = 0;
            $error_message .= 'Hanya ini yang diperbolehkan: jpg, jpeg, gif, png, pdf, doc, docx, ppt, pptx, xls, xlsx, zip, rar<br>';
        }
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'File Berhasil Di Update..';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="file.php" class="btn btn-primary btn-sm">Lihat Semua</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Judul File <span>*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="file_title" value="<?php echo $file_title; ?>">
							</div>
						</div>
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">File Saat Ini</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Tambahkan Baru <span>*</span></label>
