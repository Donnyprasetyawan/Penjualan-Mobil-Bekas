...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="page-add.php" class="btn btn-primary btn-sm">Tambah Halaman</a>
	</div>
</section>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        ...
	                        <a href="#" class="btn btn-danger btn-xs" data-href="page-delete.php?id=<?php echo $row['page_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Hapus</a>
	                    </td>
	                </tr>
            		<?php
            	}
