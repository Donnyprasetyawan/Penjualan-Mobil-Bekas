...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['faq_category_name'])) {
        $valid = 0;
        $error_message .= "Nama Kategori FAQ Tidak Boleh Kosong.<br>";
    } else {
		// Duplicate checking
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Nama Kategori FAQ Tersebut Sudah Ada<br>';
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Kategori FAQ Berhasil Di Update..';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="faq-category.php" class="btn btn-primary btn-sm">Lihat Semua</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nama Kategori FAQ <span>*</span></label>
							<div class="col-sm-4">
