...
<section class="content-header">
	<div class="content-header-left">
		<h1>Daftar Mobil Pending</h1>
	</div>
	<div class="content-header-right">
		<a href="car-approved.php" class="btn btn-primary btn-sm">Mobil Disetujui</a>
	</div>
</section>
                ...
                foreach ($result as $row) {
	                ...
	                <tr>
	                    ...
	                    <td>
                            ...
                            <a href="#" class="btn btn-warning btn-xs" data-href="car-pending-action.php?id=<?php echo $row['car_id']; ?>" data-toggle="modal" data-target="#confirm-approve">Setujui</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="rTable">
                            ...
                            <div class="rTableRow">
                                <div class="rTableHead">Tipe Mobil</div>
                                <div class="rTableCell">
                          ...
                          <!--  <div class="rTableRow">
                            ...
                            <div class="rTableRow">
                                <div class="rTableHead">Deskripsi Penjual</div>
                                <div class="rTableCell">
...
<div class="modal fade" id="confirm-approve" tabindex="-2" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel1">Konfirmasi Persetujuan</h4>
            </div>
            <div class="modal-body">
                Apakah Kamu Yakin Ingin Menyetujui Item Ini ?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batalkan</button>
                <a class="btn btn-danger btn-ok">Setujui</a>
            </div>
        </div>
    </div>
</div>
