...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['designation'])) {
		$valid = 0;
		$error_message .= 'Jabatan Tidak Boleh Kosong.<br>';
	}

	if(empty($_POST['company'])) {
		$valid = 0;
		$error_message .= 'Nama Perusahaan Tidak Boleh Kosong.<br>';
	}
    ...
    if(empty($_POST['comment'])) {
		$valid = 0;
		$error_message .= 'Komentar Tidak Boleh Kosong.<br>';
	}
	...
	if($valid == 1) {
		...
		$success_message = 'Testimonial Berhasil Ditambahkan!';
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="testimonial.php" class="btn btn-primary btn-sm">Lihat Semua</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Gambar <span>*</span></label>
							<div class="col-sm-9" style="padding-top:5px">
								<input type="file" name="photo">(Hanya diperbolehkan jpg, jpeg, gif dan png)
							</div>
						</div>						
						<div class="form-group">
