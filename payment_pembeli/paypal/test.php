...
if (!isset($_POST["txn_id"]) && !isset($_POST["txn_type"])){
	...
	$statement = $pdo->prepare("INSERT INTO tbl_payment_pembeli (pembeli_id,payment_date,timestamp_start,timestamp_end,txnid, paid_amount,pricing_plan_id,payment_status,payment_id) VALUES (?,?,?,?,?,?,?,?,?)");
	$sql = $statement->execute(array($_SESSION['pembeli']['pembeli_id'],$payment_date,$item_number,$item_number,'',$item_amount,$_POST['pricing_plan_id'],'Pending',$item_number));
