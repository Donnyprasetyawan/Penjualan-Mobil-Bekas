				...
				<div class="detail-dashboard">
					...
					<table id="example" class="display" width="100%" cellspacing="0">
						...
						<tbody>
							<?php
							$i = 0;
							$statement = $pdo->prepare("SELECT * FROM tbl_pembelian WHERE pembayaran='Kredit' AND pembeli_id=?");
									...
									<tr>
										...
										<td class="text-center">
                                            <?php if ($status == 'Terverifikasi'): ?>
                                                <a href="<?php echo BASE_URL; ?>pembelian-kredit-detail.php?id=<?php echo $idbook; ?>" class="btn btn-success">Bayar</a>
                                            <?php else: ?>
                                                -
                                            <?php endif ?>
