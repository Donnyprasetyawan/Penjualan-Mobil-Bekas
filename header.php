...
\Midtrans\Config::$serverKey = 'SB-Mid-server-PpoDMBWeJ3aN0u64BZUVoEML';
...
if($mod_rewrite == 'Off') {
	...
	define("URL_BOOKING", "booking.php?id=");
	define("URL_BAYAR", "bayar.php?id=");
	...
	define("URL_CAR", "car/");
	define("URL_BOOKING", "booking/");
	define("URL_BAYAR", "bayar/");
...
?>
	...
	<!--Preloader Start-->
	<div id="preloader">
		<div id="status" style="background-image: url(<?php echo BASE_URL; ?>img/preloader/3.gif)"></div>
	</div>
	<!--Preloader End-->
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="top-header-right">
						...
						<?php if(!isset($_SESSION['pembeli'])): ?>
							<a href="login.php"><i class="fa fa-sign-in"></i>Login Pembeli</a>
							<a href="<?php echo BASE_URL; ?>penjual/login.php"><i class="fa fa-sign-in"></i>Login Penjual</a>
						<?php else: ?>
							Masuk Sebagai: <?php echo $_SESSION['pembeli']['pembeli_name']; ?>
							|
