							...
							<div class="tab-pane" id="booking">
								<div class="car-tab-text">
									...
									<div class="car-tab-pre">
										...
										<?php
											if(isset($_POST['booking'])) {
												...
												if($valid == 1) {
													...
													$statement = $pdo->prepare("INSERT INTO tbl_booking (pembeli_id,pembayaran,pembooking,nope,email,penjual,mobil,nama_bank,lama_cicil,lama_book) VALUES (?,?,?,?,?,?,?,?,?,?)");
													$statement->execute(array($_POST['pembeli_id'],$_POST['metode'],$_POST['pembooking'],$_POST['nope'],$_POST['email'],$_POST['penjual'],$_POST['mobil'],$_POST['bank'],$_POST['cicilan'],$_POST['lama']));
											
													$success_message = 'Sip, Booking Mu Berhasil.';
												}
											}
											?>
										...
										?>
										<?php if($allowed == 0): ?>
										<div class="error">Form Booking Mobil Akan Muncul Setelah Anda Melakukan Pembayaran Uang Muka. <a href="<?php echo BASE_URL; ?>payment.php" style="color:red;text-decoration:underline;">klik Disini</a> Untuk Melakukan Pembayaran.</div>
										<?php else: ?>
										<form class="form-horizontal" action="" method="post">
											<div class="box box-info">
												<div style="margin-left:180px;" class="box-body">
													...
													<div style="display:flex;flex-direction:column;width:1000px;" class="form-group">
														<label for="" style="text-align:center;" class="col-md-4 control-label">Lama Booking<span> *</span></label>
														<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<button type="submit" class="btn btn-success pull-left" name="booking">Booking Sekarang</button>
														</div>
													</div>
												</div>
											</div>
