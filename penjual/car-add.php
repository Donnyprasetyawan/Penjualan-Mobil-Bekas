...
if(isset($_POST['form1'])) {
    ...
    if($path!='') {
        ...
        if(!$ext_check) {
            $valid = 0;
            $error_message .= 'Kamu harus mengupload file dengan format jpg, jpeg, gif atau png file.\n';
        }
    } else {
    	$valid = 0;
	...
	if($total_car >= $pricing_plan_item_allow) {
		$valid = 0;
		$error_message .= 'Anda Telah Mencapai Batas Maksimal Upload Mobil.\n';
	}
    ...
    if($valid == 1) {
        ...
        $success_message .= "Mobil berhasil ditambahkan. Sedang diverifikasi oleh Admin.";
		...
		<div class="row">
			...
			<div class="col-md-9 col-sm-12">
				<div class="detail-dashboard">
					...
					?>
					<?php if($allowed == 0): ?>
					<div class="error">Kamu Bisa Upload Mobil Setelah Melakukan Pembayaran Paket Sewa Tempat.</div>
					<?php else: ?>
								...
								<form action="" method="post" enctype="multipart/form-data">
									<div class="form-row">
										<div class="form-group col-md-12 col-sm-12">
											...
											<input autocomplete="off" type="text" class="form-control" name="title" placeholder="Masukkan Nama Mobil Disini" value="<?php if(isset($_POST['title'])) {echo $_POST['title'];} ?>">
										</div>
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											...
											<select data-placeholder="Pilih Item ..." class="form-control brand" name="model_id">
                                                <?php
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											<label for="">Kategori Mobil</label>
											<select data-placeholder="Pilih Item ..." class="form-control chosen-select" name="car_category_id">
												<?php
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											<label for="">Tipe Body</label>
											<select data-placeholder="Pilih Item ..." class="form-control chosen-select" name="body_type_id">
												<?php
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											...
											<select data-placeholder="Pilih Item ..." class="form-control chosen-select" name="fuel_type_id">
												<?php
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											...
											<select data-placeholder="Pilih Item ..." class="form-control chosen-select" name="transmission_type_id">
												<?php
										...
										<div class="form-group col-md-6 col-sm-6">
											<label for="">VIN</label>
											<input autocomplete="off" type="text" class="form-control" name="vin" placeholder="Nomor Serial Mobil" value="<?php if(isset($_POST['vin'])) {echo $_POST['vin'];} ?>">
										</div>
										<input type="hidden" name="car_condition" value="Old Car">
										<!-- <div class="form-group col-md-6 col-sm-6 option-item">
											<label for="">Kondisi *</label>
											<select data-placeholder="Pilih Item ..." class="form-control chosen-select" name="car_condition">
												<option></option>
												<option value="New Car">Mobil Baru</option>
												<option value="Old Car">Mobil Lama</option>
											</select>
										</div> -->
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Mesin</label>
											<input autocomplete="off" type="text" class="form-control" name="engine" placeholder="Nama Mesin" value="<?php if(isset($_POST['engine'])) {echo $_POST['engine'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Ukuran Mesin</label>
											<input autocomplete="off" type="text" class="form-control" name="engine_size" placeholder="Ukuran Mesin dalam cc" value="<?php if(isset($_POST['engine_size'])) {echo $_POST['engine_size'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Warna Luar</label>
											<input autocomplete="off" type="text" class="form-control" name="exterior_color" placeholder="Warna Luar" value="<?php if(isset($_POST['exterior_color'])) {echo $_POST['exterior_color'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Warna Dalam</label>
											<input autocomplete="off" type="text" class="form-control" name="interior_color" placeholder="Warna Dalam" value="<?php if(isset($_POST['interior_color'])) {echo $_POST['interior_color'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Jumlah Kursi</label>
											<input autocomplete="off" type="text" class="form-control" name="seat" placeholder="Jumlah Kursi" value="<?php if(isset($_POST['seat'])) {echo $_POST['seat'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Jumlah Pintu</label>
											<input autocomplete="off" type="text" class="form-control" name="door" placeholder="Jumlah Pintu" value="<?php if(isset($_POST['door'])) {echo $_POST['door'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Max Kecepatan</label>
											<input autocomplete="off" type="text" class="form-control" name="top_speed" placeholder="Max Kecepatan" value="<?php if(isset($_POST['top_speed'])) {echo $_POST['top_speed'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Kilometers</label>
											<input autocomplete="off" type="text" class="form-control" name="kilometer" placeholder="Kilometers (Hanya untuk mobil lama)" value="<?php if(isset($_POST['kilometer'])) {echo $_POST['kilometer'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Jarak Tempuh</label>
											<input autocomplete="off" type="text" class="form-control" name="mileage" placeholder="Jarak Tempuh/Liter" value="<?php if(isset($_POST['mileage'])) {echo $_POST['mileage'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6 option-item">
											<label for="">Tahun Pembuatan</label>
											<select data-placeholder="Pilih Item ..." class="form-control chosen-select" name="year">
												<option></option>
												<?php
												$current_year = date('Y');
										...
										<div class="form-group col-md-6 col-sm-6">
											...
											<input autocomplete="off" type="text" class="form-control" name="warranty" placeholder="Garansi (berapa tahun ?)" value="<?php if(isset($_POST['warranty'])) {echo $_POST['warranty'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Negara</label>
											<input autocomplete="off" type="text" class="form-control" name="country" placeholder="Negara" value="<?php if(isset($_POST['country'])) {echo $_POST['country'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Provinsi</label>
											<input autocomplete="off" type="text" class="form-control" name="state" placeholder="Provinsi" value="<?php if(isset($_POST['state'])) {echo $_POST['state'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Kota</label>
											<input autocomplete="off" type="text" class="form-control" name="city" placeholder="Kota" style="<?php if(isset($_POST['city'])) {echo $_POST['city'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Kode Pos</label>
											<input autocomplete="off" type="text" class="form-control" name="zip_code" placeholder="Kode Pos" value="<?php if(isset($_POST['zip_code'])) {echo $_POST['zip_code'];} ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Alamat</label>
											<input type="text" class="form-control" name="address" placeholder="Alamat" value="<?php if(isset($_POST['address'])) {echo $_POST['address'];} ?>">
										</div>
										<div class="form-group col-md-12 col-sm-12">
											<label for="">Map</label>
									...
									<div class="form-group col-md-12">
										<label for="">Foto Unggulan *</label>
										<input type="file" class="form-control-file" name="featured_photo">
								 	</div>

								 	<div class="form-group col-md-6">
										<label for="">Tambahkan Foto (Tambahkan Sesuka Hati)</label>
										...
										<div>
							                <input type="button" id="btnAddNew1" value="Tambah Foto Baru" class="btn btn-warning btn-xs" style="padding:3px 10px;font-size:12px;height:30px;">
							            </div>
								 	...
								 	<div class="form-group col-md-6 col-sm-6">
										...
										<input autocomplete="off" type="text" class="form-control" name="regular_price" placeholder="Harga Reguler Dalam Juta" value="<?php if(isset($_POST['regular_price'])) {echo $_POST['regular_price'];} ?>">
									</div>

									<div class="form-group col-md-6 col-sm-6">
										<label for="">Harga Jual *</label>
										<input autocomplete="off" type="text" class="form-control" name="sale_price" placeholder="Harga Jual Dalam Juta" value="<?php if(isset($_POST['sale_price'])) {echo $_POST['sale_price'];} ?>">
									</div>
									
									<div class="form-group col-md-12">
										<label for="">Deskripsi</label>
										<textarea class="form-control" name="description"><?php if(isset($_POST['description'])) {echo $_POST['description'];} ?></textarea>
										<button type="submit" class="btn btn-primary" name="form1">Tambahkan</button>
									</div>
