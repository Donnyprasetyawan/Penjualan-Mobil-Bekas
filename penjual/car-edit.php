...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message .= "Mobil Berhasil Di Update.. Mohon tunggu, Admin sedang memverifikasi mobil anda.";
								...
								<form action="" method="post" enctype="multipart/form-data">
									<div class="form-row">
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											...
											<select data-placeholder="Pilih Item ..." class="form-control model" name="model_id">
												<?php
										...
										<div class="form-group col-md-6 col-sm-6">
											<label for="">VIN</label>
											<input autocomplete="off" type="text" class="form-control" name="vin" placeholder="Nomor Serial Mobil" value="<?php echo $vin; ?>">
										</div>
										...
										<!-- <div class="form-group col-md-6 col-sm-6 option-item">
											...
											<select data-placeholder="Pilih Item ..." class="form-control chosen-select" name="car_condition">
												<option></option>
												<option value="New Car" <?php // if($car_condition == 'New Car'){echo 'selected';} ?>>Mobil Baru</option>
												<option value="Old Car" <?php // if($car_condition == 'Old Car'){echo 'selected';} ?>>Mobil Lama</option>
											</select>
										</div> -->
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Mesin</label>
											<input autocomplete="off" type="text" class="form-control" name="engine" placeholder="Nama Mesin" value="<?php echo $engine; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Ukuran Mesin</label>
											<input autocomplete="off" type="text" class="form-control" name="engine_size" placeholder="Ukuran Mesin dalam cc" value="<?php echo $engine_size; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Warna Luar</label>
											<input autocomplete="off" type="text" class="form-control" name="exterior_color" placeholder="Warna Luar" value="<?php echo $exterior_color; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Warna Dalam</label>
											<input autocomplete="off" type="text" class="form-control" name="interior_color" placeholder="Warna Dalam" value="<?php echo $interior_color; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Jumlah Kursi</label>
											<input autocomplete="off" type="text" class="form-control" name="seat" placeholder="Jumlah Kursi" value="<?php echo $seat; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Jumlah Pintu</label>
											<input autocomplete="off" type="text" class="form-control" name="door" placeholder="Jumlah Pintu" value="<?php echo $door; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Max Kecepatan</label>
											<input autocomplete="off" type="text" class="form-control" name="top_speed" placeholder="Max Kecepatan" value="<?php echo $top_speed; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Kilometers</label>
											<input autocomplete="off" type="text" class="form-control" name="kilometer" placeholder="Kilometers (hanya untuk mobil lama)" value="<?php echo $kilometer; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Jarak Tempuh</label>
											<input autocomplete="off" type="text" class="form-control" name="mileage" placeholder="Jarak Tempuh/Liter" value="<?php echo $mileage; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6 option-item">
										...
										<div class="form-group col-md-6 col-sm-6">
											...
											<input autocomplete="off" type="text" class="form-control" name="warranty" placeholder="Garansi (berapa tahun ?)" value="<?php echo $warranty; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Negara</label>
											<input autocomplete="off" type="text" class="form-control" name="country" placeholder="Negara" value="<?php echo $country; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Provinsi</label>
											<input autocomplete="off" type="text" class="form-control" name="state" placeholder="Provinsi" value="<?php echo $state; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Kota</label>
											<input autocomplete="off" type="text" class="form-control" name="city" placeholder="Kota" value="<?php echo $city; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
											<label for="">Kode Pos</label>
											<input autocomplete="off" type="text" class="form-control" name="zip_code" placeholder="Kode Pos" value="<?php echo $zip_code; ?>">
										</div>
										<div class="form-group col-md-6 col-sm-6">
									...
									<div class="form-group col-md-12">
								 	...
								 	<div class="form-group col-md-6">
										...
										<div>
							                <input type="button" id="btnAddNew1" value="Tambahkan Foto Baru" class="btn btn-warning btn-xs" style="padding:3px 10px;font-size:12px;height:30px;">
							            </div>						                
								 	</div>
								 	...
								 	<div class="form-group col-md-6 col-sm-6">
										...
										<input autocomplete="off" type="text" class="form-control" name="regular_price" placeholder="Harga Jual Dalam Juta" value="<?php echo $regular_price; ?>">
									</div>

									<div class="form-group col-md-6 col-sm-6">
										<label for="">Harga Jual *</label>
										<input autocomplete="off" type="text" class="form-control" name="sale_price" placeholder="Harga Jual Dalam Juta" value="<?php echo $sale_price; ?>">
									</div>
