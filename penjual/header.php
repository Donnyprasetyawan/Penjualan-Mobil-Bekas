				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="top-header-right">
						...
						<?php if(!isset($_SESSION['seller'])): ?>
							<a href="registration.php"><i class="fa fa-sign-in"></i>Daftar Penjual</a>
							<a href="login.php"><i class="fa fa-sign-in"></i>Login Penjual</a>
						<?php else: ?>
							Masuk Sebagai: <?php echo $_SESSION['seller']['seller_name']; ?>
							|
