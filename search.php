...
?>
    ...
    <div class="banner-slider"
         style="background-image: url(<?php echo BASE_URL . 'assets/uploads/' . $banner_search; ?>)">
        <div class="bg"></div>
                    ...
                    if ($total_res == ''):
                        ...
                        foreach ($result as $row) {
                            ...
                            <div class="row listing-item child">
                                <div class="col-md-4 col-sm-4 col-xs-12 listing-photo"
                                     style="background-image: url(<?php echo BASE_URL . 'assets/uploads/cars/' . $row['featured_photo']; ?>)"></div>
